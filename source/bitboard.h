...
// 左側を表現するBitboard。
extern Bitboard InLeftBB[COLOR_NB][RANK_NB];
// 右側を表現するBitboard。
extern Bitboard InRightBB[COLOR_NB][RANK_NB];
// 以前を表現するBitboard。
extern Bitboard OrFrontBB[COLOR_NB][RANK_NB];
// 以後を表現するBitboard。
extern Bitboard OrBackBB[COLOR_NB][RANK_NB];
// 以左を表現するBitboard。
extern Bitboard OrLeftBB[COLOR_NB][RANK_NB];
// 以右を表現するBitboard。
extern Bitboard OrRightBB[COLOR_NB][RANK_NB];
