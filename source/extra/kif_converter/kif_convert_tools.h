...
struct KifFormat {
	...
	KifFormat(ColorFormat cfmt = ColorFmt_KIF, SquareFormat sqfmt = SqFmt_ASCII, SamePosFormat spfmt = SamePosFmt_Short)
	    : color_type(cfmt), square_type(sqfmt), samepos_type(spfmt) {}
};
