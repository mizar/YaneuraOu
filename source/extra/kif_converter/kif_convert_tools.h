...
namespace KifConvertTools
{
	...
	extern std::string to_kif2_string(Position& pos, Move m, const KifFormat& fmt = KifFmtA);
	extern std::string to_kif2_u8string(Position& pos, Move m, const KifFormat& fmt = KifFmtA);
	extern std::u16string to_kif2_u16string(Position& pos, Move m, const KifFormat& fmt = KifFmtA);
	extern std::u32string to_kif2_u32string(Position& pos, Move m, const KifFormat& fmt = KifFmtA);
	extern std::wstring to_kif2_wstring(Position& pos, Move m, const KifFormat& fmt = KifFmtA);
