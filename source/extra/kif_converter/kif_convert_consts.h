...
template <typename charT>
struct EalenSstream : public std::basic_stringstream<charT> {
...
// 文字幅カウント付きの文字列処理
template <typename charT>
EalenSstream<charT>& operator<<(EalenSstream<charT>& ess, KifConstEntry<charT> s) {
	ess._ealen += s.ealen;
	ess << s.str;
	return ess;
}
...
#define SCU(I, T, S, R)                                               \
	(KifConstEntry<T>(                                                \
	    std::get<I>(std::make_tuple(R, u8"" S, u"" S, U"" S, L"" S)), \
	    std::get<I>(std::make_tuple(eawidth(U"" R), eawidth(U"" S), eawidth(U"" S), eawidth(U"" S), eawidth(U"" S)))))
#endif
...
struct KifConst : KifCharBase<T> {
	typedef T                    char_type;
	typedef std::basic_string<T> string_type;
	typedef KifConstEntry<T>     value_type;
	const value_type             csa_color_black = SC(I, T, "+");
	const value_type             csa_color_white = SC(I, T, "-");
	const value_type             csa_move_none   = SC(I, T,
                                        "%"
                                        "ERROR");
	const value_type             csa_move_null   = SC(I, T,
                                        "%"
                                        "PASS");
	const value_type             csa_move_resign = SC(I, T,
                                          "%"
                                          "TORYO");
	const value_type             csa_move_win    = SC(I, T,
                                       "%"
                                       "WIN");
	const value_type             csa_cap_sq      = SC(I, T, "00");
	const value_type             csa_piece[16]   = {
        SC(I, T, "**"), SC(I, T, "FU"), SC(I, T, "KY"), SC(I, T, "KE"), SC(I, T, "GI"), SC(I, T, "KA"),
        SC(I, T, "HI"), SC(I, T, "KI"), SC(I, T, "OU"), SC(I, T, "TO"), SC(I, T, "NY"), SC(I, T, "NK"),
        SC(I, T, "NG"), SC(I, T, "UM"), SC(I, T, "RY"), SC(I, T, "QU"),
    };
	...
	const value_type csa_pos_rank[9] = {
	    SC(I, T, "P1"), SC(I, T, "P2"), SC(I, T, "P3"), SC(I, T, "P4"), SC(I, T, "P5"),
	    SC(I, T, "P6"), SC(I, T, "P7"), SC(I, T, "P8"), SC(I, T, "P9"),
	};
	const value_type csa_pos_piece[32] = {
	    SC(I, T, " * "), SC(I, T, "+FU"), SC(I, T, "+KY"), SC(I, T, "+KE"), SC(I, T, "+GI"), SC(I, T, "+KA"),
	    SC(I, T, "+HI"), SC(I, T, "+KI"), SC(I, T, "+OU"), SC(I, T, "+TO"), SC(I, T, "+NY"), SC(I, T, "+NK"),
	    SC(I, T, "+NG"), SC(I, T, "+UM"), SC(I, T, "+RY"), SC(I, T, "+QU"), SC(I, T, " * "), SC(I, T, "-FU"),
	    SC(I, T, "-KY"), SC(I, T, "-KE"), SC(I, T, "-GI"), SC(I, T, "-KA"), SC(I, T, "-HI"), SC(I, T, "-KI"),
	    SC(I, T, "-OU"), SC(I, T, "-TO"), SC(I, T, "-NY"), SC(I, T, "-NK"), SC(I, T, "-NG"), SC(I, T, "-UM"),
	    SC(I, T, "-RY"), SC(I, T, "-QU"),
	};
	...
	const value_type char1to9_ascii[9]    = {
        SC(I, T, "1"), SC(I, T, "2"), SC(I, T, "3"), SC(I, T, "4"), SC(I, T, "5"),
        SC(I, T, "6"), SC(I, T, "7"), SC(I, T, "8"), SC(I, T, "9"),
    };
	const value_type char1to9_kanji[9] = {
	    SC(I, T, "一"), SC(I, T, "二"), SC(I, T, "三"), SC(I, T, "四"), SC(I, T, "五"),
	    SC(I, T, "六"), SC(I, T, "七"), SC(I, T, "八"), SC(I, T, "九"),
	};
	const value_type char1to9_full_width_arabic[9] = {
	    SC(I, T, "１"), SC(I, T, "２"), SC(I, T, "３"), SC(I, T, "４"), SC(I, T, "５"),
	    SC(I, T, "６"), SC(I, T, "７"), SC(I, T, "８"), SC(I, T, "９"),
	};
	const value_type kif_piece[16] = {
	    SC(I, T, "・"),   SC(I, T, "歩"), SC(I, T, "香"), SC(I, T, "桂"), SC(I, T, "銀"),   SC(I, T, "角"),
	    SC(I, T, "飛"),   SC(I, T, "金"), SC(I, T, "玉"), SC(I, T, "と"), SC(I, T, "成香"), SC(I, T, "成桂"),
	    SC(I, T, "成銀"), SC(I, T, "馬"), SC(I, T, "龍"), SC(I, T, "女"),
	};
	...
	const value_type bod_piece[32] = {
	    SC(I, T, " ・"), SC(I, T, " 歩"), SC(I, T, " 香"), SC(I, T, " 桂"), SC(I, T, " 銀"), SC(I, T, " 角"),
	    SC(I, T, " 飛"), SC(I, T, " 金"), SC(I, T, " 玉"), SC(I, T, " と"), SC(I, T, " 杏"), SC(I, T, " 圭"),
	    SC(I, T, " 全"), SC(I, T, " 馬"), SC(I, T, " 龍"), SC(I, T, " 女"), SC(I, T, " ・"), SC(I, T, "v歩"),
	    SC(I, T, "v香"), SC(I, T, "v桂"), SC(I, T, "v銀"), SC(I, T, "v角"), SC(I, T, "v飛"), SC(I, T, "v金"),
	    SC(I, T, "v玉"), SC(I, T, "vと"), SC(I, T, "v杏"), SC(I, T, "v圭"), SC(I, T, "v全"), SC(I, T, "v馬"),
	    SC(I, T, "v龍"), SC(I, T, "v女"),
	};
	...
	const value_type bod_hand_piece[16]   = {
        SC(I, T, "・"), SC(I, T, "歩"), SC(I, T, "香"), SC(I, T, "桂"), SC(I, T, "銀"), SC(I, T, "角"),
        SC(I, T, "飛"), SC(I, T, "金"), SC(I, T, "玉"), SC(I, T, "と"), SC(I, T, "杏"), SC(I, T, "圭"),
        SC(I, T, "全"), SC(I, T, "馬"), SC(I, T, "龍"), SC(I, T, "女"),
    };
	const value_type bod_hand_pad     = SC(I, T, " ");
	const value_type bod_hand_none    = SC(I, T, "なし");
	const value_type bod_hand_num[19] = {
	    SC(I, T, ""),     SC(I, T, ""),     SC(I, T, "二"),   SC(I, T, "三"),   SC(I, T, "四"),
	    SC(I, T, "五"),   SC(I, T, "六"),   SC(I, T, "七"),   SC(I, T, "八"),   SC(I, T, "九"),
	    SC(I, T, "十"),   SC(I, T, "十一"), SC(I, T, "十二"), SC(I, T, "十三"), SC(I, T, "十四"),
	    SC(I, T, "十五"), SC(I, T, "十六"), SC(I, T, "十七"), SC(I, T, "十八"),
	};
	...
	const value_type char0to9_ascii[10]  = {
        SC(I, T, "0"), SC(I, T, "1"), SC(I, T, "2"), SC(I, T, "3"), SC(I, T, "4"),
        SC(I, T, "5"), SC(I, T, "6"), SC(I, T, "7"), SC(I, T, "8"), SC(I, T, "9"),
    };
};
