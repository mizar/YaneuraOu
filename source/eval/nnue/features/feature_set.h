...
struct CompileTimeList<T> {
	static constexpr bool             Contains(T /*value*/) { return false; }
...
struct InsertToSet<T, CompileTimeList<T, First, Remaining...>, AnotherValue> {
	using Result = std::conditional_t<
	    CompileTimeList<T, First, Remaining...>::Contains(AnotherValue), CompileTimeList<T, First, Remaining...>,
	    std::conditional_t<
	        (AnotherValue < First), CompileTimeList<T, AnotherValue, First, Remaining...>,
...
class FeatureSet<FirstFeatureType, RemainingFeatureTypes...>
   ...
   public:
	...
	using SortedTriggerSet =
	    typename InsertToSet<TriggerEvent, typename Tail::SortedTriggerSet, Head::kRefreshTrigger>::Result;
	static constexpr auto kRefreshTriggers = SortedTriggerSet::kValues;

	// 特徴量名を取得する
	static std::string GetName() { return std::string(Head::kName) + "+" + Tail::GetName(); }
...
class FeatureSet<FeatureType> : public FeatureSetBase<FeatureSet<FeatureType>> {
   public:
	...
	// 特徴量名を取得する
	static std::string GetName() { return FeatureType::kName; }
