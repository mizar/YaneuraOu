...
#elif defined(EVAL_KPP_KKPT) || defined(EVAL_KKPP_KKPT) || defined(EVAL_KPP_KKPT_FV_VAR) || defined(EVAL_HELICES) || \
    defined(EVAL_NABLA)
...
static bool operator==(const EvalSum& lhs, const EvalSum rhs) {
	return lhs.p[0] == rhs.p[0] && lhs.p[1] == rhs.p[1] && lhs.p[2] == rhs.p[2];
}
