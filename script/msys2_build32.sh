...
EDITIONS=(
  ...
  "YANEURAOU_ENGINE_MATERIAL MATERIAL_LEVEL=007"
#  "YANEURAOU_ENGINE_MATERIAL MATERIAL_LEVEL=008"
#  "YANEURAOU_ENGINE_MATERIAL MATERIAL_LEVEL=009"
#  "YANEURAOU_ENGINE_MATERIAL MATERIAL_LEVEL=0010"
  MATE_ENGINE
  USER_ENGINE
)
...
DIRSTR=(
  ...
  ["YANEURAOU_ENGINE_MATERIAL MATERIAL_LEVEL=007"]="MaterialLv7"
  ["YANEURAOU_ENGINE_MATERIAL MATERIAL_LEVEL=008"]="MaterialLv8"
  ["YANEURAOU_ENGINE_MATERIAL MATERIAL_LEVEL=009"]="MaterialLv9"
  ["YANEURAOU_ENGINE_MATERIAL MATERIAL_LEVEL=010"]="MaterialLv10"
  ["MATE_ENGINE"]="MATE"
);
...
FILESTR=(
  ...
  ["YANEURAOU_ENGINE_MATERIAL MATERIAL_LEVEL=007"]="YaneuraOu_MaterialLv7"
  ["YANEURAOU_ENGINE_MATERIAL MATERIAL_LEVEL=008"]="YaneuraOu_MaterialLv8"
  ["YANEURAOU_ENGINE_MATERIAL MATERIAL_LEVEL=009"]="YaneuraOu_MaterialLv9"
  ["YANEURAOU_ENGINE_MATERIAL MATERIAL_LEVEL=010"]="YaneuraOu_MaterialLv10"
